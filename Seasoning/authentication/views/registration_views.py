    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 
                                 _('A new activation email has been sent to {email_address}. This email should arrive within 15 minutes. Please be sure to check your Spam/Junk folder.').format(email_address=form.cleaned_data['email']))
